...
class JellyHALibraryStorageSensor(JellyHABaseSensor):
    ...
    def __init__(
        ...
        super().__init__(coordinator, entry, device_name, f"library_storage_{library_id}")
        self._library_id = library_id
        self._library_name = library_name
        # Set the sensor name to the library name
        self._attr_name = f"{library_name} Storage Size"
